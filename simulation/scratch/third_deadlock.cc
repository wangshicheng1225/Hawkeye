...
// loop NPA: set route 
void CalculateRouteAll(){
	Ptr<Node> node0 = n.Get(0);
	Ptr<Node> node1 = n.Get(1);
	Ptr<Node> node2 = n.Get(2);
	Ptr<Node> node3 = n.Get(3);
	Ptr<Node> node4 = n.Get(4);
	Ptr<Node> node5 = n.Get(5);
	Ptr<Node> node6 = n.Get(6);
	Ptr<Node> node7 = n.Get(7);
	Ptr<Node> node8 = n.Get(8);
	Ptr<Node> node9 = n.Get(9);
	Ptr<Node> node10 = n.Get(10);
	Ptr<Node> node11 = n.Get(11);
	Ptr<Node> node12 = n.Get(12);
	Ptr<Node> node13 = n.Get(13);
	Ptr<Node> node14 = n.Get(14);
	Ptr<Node> node15 = n.Get(15);
	Ptr<Node> node16 = n.Get(16);
	Ptr<Node> node17 = n.Get(17);
	Ptr<Node> node18 = n.Get(18);
	Ptr<Node> node19 = n.Get(19);

	// flow 1: 4 -> 0 -> 1 -> 3 -> 7
	nextHop[node4][node7].push_back(node0);
	nextHop[node0][node7].push_back(node1);
	nextHop[node1][node7].push_back(node3);
	nextHop[node3][node7].push_back(node7);
	// back path: 7 -> 3 -> 1 -> 0 -> 4
	nextHop[node7][node4].push_back(node3);
	nextHop[node3][node4].push_back(node1);
	nextHop[node1][node4].push_back(node0);
	nextHop[node0][node4].push_back(node4);

	//flow 2: 11 -> 3 -> 2 -> 0 -> 8
	nextHop[node11][node8].push_back(node3);
	nextHop[node3][node8].push_back(node2);
	nextHop[node2][node8].push_back(node0);
	nextHop[node0][node8].push_back(node8);
	// back path: 8 -> 0 -> 2 -> 3 -> 11
	nextHop[node8][node11].push_back(node0);
	nextHop[node0][node11].push_back(node2);
	nextHop[node2][node11].push_back(node3);
	nextHop[node3][node11].push_back(node11);

	//flow 3: 6 -> 2 -> 0 -> 1 -> 5
	nextHop[node6][node5].push_back(node2);
	nextHop[node2][node5].push_back(node0);
	nextHop[node0][node5].push_back(node1);
	nextHop[node1][node5].push_back(node5);
	// back path: 5 -> 1 -> 0 -> 2 -> 6
	nextHop[node5][node6].push_back(node1);
	nextHop[node1][node6].push_back(node0);
	nextHop[node0][node6].push_back(node2);
	nextHop[node2][node6].push_back(node6);

	//flow 4: 9 -> 1 -> 3 -> 2 -> 10
	nextHop[node9][node10].push_back(node1);
	nextHop[node1][node10].push_back(node3);
	nextHop[node3][node10].push_back(node2);
	nextHop[node2][node10].push_back(node10);
	// back path: 10 -> 2 -> 3 -> 1 -> 9
	nextHop[node10][node9].push_back(node2);
	nextHop[node2][node9].push_back(node3);
	nextHop[node3][node9].push_back(node1);
	nextHop[node1][node9].push_back(node9);

	// flow 5-8 12 -> 16 , 13 -> 17, 14 -> 18, 15 -> 19
	nextHop[node12][node16].push_back(node1);
	nextHop[node1][node16].push_back(node3);
	nextHop[node3][node16].push_back(node16);
	nextHop[node16][node12].push_back(node3);
	nextHop[node3][node12].push_back(node1);
	nextHop[node1][node12].push_back(node12);
	nextHop[node13][node17].push_back(node1);
	nextHop[node1][node17].push_back(node3);
	nextHop[node3][node17].push_back(node17);
	nextHop[node17][node13].push_back(node3);
	nextHop[node3][node13].push_back(node1);
	nextHop[node1][node13].push_back(node13);
	nextHop[node14][node18].push_back(node1);
	nextHop[node1][node18].push_back(node3);
	nextHop[node3][node18].push_back(node18);
	nextHop[node18][node14].push_back(node3);
	nextHop[node3][node14].push_back(node1);
	nextHop[node1][node14].push_back(node14);
	nextHop[node15][node19].push_back(node1);
	nextHop[node1][node19].push_back(node3);
	nextHop[node3][node19].push_back(node19);
	nextHop[node19][node15].push_back(node3);
	nextHop[node3][node15].push_back(node1);
	nextHop[node1][node15].push_back(node15);
